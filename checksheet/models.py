...
class UpdateSheet(models.Model):
    ...
    SNPs = models.CharField(max_length=10, blank=True, null=True)
    ...
    标准材料宽度 = models.CharField(max_length=10, blank=True, null=True)
    进给量 = models.CharField(max_length=10, blank=True, null=True)
    ...
    生产数 = models.CharField(max_length=10, blank=True, null=True)
    合格数 = models.CharField(max_length=10, blank=True, null=True)
    不良数 = models.CharField(max_length=10, blank=True, null=True)
